...
```typescript
{
  file_id: string; // meeting_files.id
}
```
...
- [AI-FEATURES-DOCUMENTATION.md](../06-ai-features/AI-FEATURES-DOCUMENTATION.md) - Full feature documentation
- [QUICK-REFERENCE.md](../06-ai-features/QUICK-REFERENCE.md) - Quick reference
- [AGENT-EXECUTION-ARCHITECTURE.md](../06-ai-features/AGENT-EXECUTION-ARCHITECTURE.md) - Architecture deep dive
- [agent-builder-ui-guide.md](../06-ai-features/agent-builder-ui-guide.md) - Building custom agents
