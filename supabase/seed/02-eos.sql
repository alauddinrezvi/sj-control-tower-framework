...
-- 3. OKRs
INSERT INTO okrs (title, description, owner_id, status, quarter, start_date, end_date, progress, pod_id, created_by)
VALUES
...
INSERT INTO okr_key_results (okr_id, title, metric_type, current_value, target_value, start_value, unit, status, owner_id, sort_order) VALUES
  ...
  (okr1, 'QA checklist items tested',             'number',     0,  85, 0, 'items',    'not_started', u1, 2),
  (okr1, 'Demo seed data coverage',               'percentage', 10, 100, 0, '%',       'at_risk',   u1, 3),
