...
INSERT INTO okr_key_results (okr_id, title, metric_type, current_value, target_value, start_value, unit, status, owner_id, sort_order) VALUES
  ...
  (okr1, 'QA checklist items tested',             'number',     45, 85, 0, 'items',    'in_progress', u1, 2),
  ...
  (okr4, 'Monitoring alerts configured',           'number',     5,  20, 0, 'alerts',   'in_progress', u1, 3),
  ...
  (okr7, 'Course modules completed',              'number',     6,  12, 0, 'modules',  'in_progress', u1, 1),
