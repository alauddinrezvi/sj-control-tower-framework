-- ============================================================================
-- ONE-TIME FIX: Create agent_conversations + agent_messages
-- Run in Supabase Dashboard → SQL Editor if you see PGRST205:
-- "Could not find the table 'public.agent_messages' in the schema cache"
-- ============================================================================
