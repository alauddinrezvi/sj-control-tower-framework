...
export const implementationStatus: ModuleStatus[] = [
  ...
  // ── Phase 5: Projects ────────────────────────────────────────────────────────
  {
    ...
    phase: 5,
    owner: "Zia",
    summary: "Full CRUD with milestones, members, risks, billing. Client portal, ActiveCollab/Jira sync, project knowledge tabs added.",
    pipeline: {
      development: { status: "in-progress", owner: "Zia", notes: "Core done, client portal live, integrations + knowledge tabs partially wired" },
    ...
    hooks: [
      ...
      { name: "useProjectReports — project metrics aggregation", status: "in-progress", notes: "uses mock data" },
      { name: "useProjectIntegrations — integration status per project", status: "in-progress", notes: "mock data" },
      { name: "useProjectTasks — project tasks from multiple sources", status: "in-progress", notes: "mock data" },
    ],
    components: [
      { name: "ClientAccessManagement — client portal credential management", status: "done" },
      { name: "IntegrationsTab — project integration status", status: "in-progress", notes: "mock data" },
      { name: "TasksTab — project tasks from internal/AC/Jira", status: "in-progress", notes: "mock data" },
    ...
    nextSteps: [
      "Wire IntegrationsTab and TasksTab to real data (replace mock)",
  ...
  // ── Phase 8: Admin ───────────────────────────────────────────────────────────
  {
    ...
    phase: 8,
    owner: "Shahed",
    summary: "30+ admin pages. Team management, knowledge admin, embeddings explorer, seed runner, Zoom integration, project settings, reports.",
    pipeline: {
    ...
    pages: [
      ...
      { name: "ProjectStatusSettings — project status config (stub)", status: "planned" },
      { name: "ProjectModules — toggle project detail tabs", status: "in-progress" },
      { name: "WorkTypesSettings — work type management (stub)", status: "planned" },
      { name: "ProjectReports — project metrics overview", status: "in-progress", notes: "uses mock data" },
      { name: "ResourceUtilizationReports — resource allocation (stub)", status: "planned" },
    ...
    qaChecklist: [
      ...
      { description: "Navigate /admin/reports/projects and see metrics", tested: false },
    ],
    nextSteps: [
      "Wire ProjectReports to real database aggregates (replace mock data)",
      "Build ProjectStatusSettings CRUD",
